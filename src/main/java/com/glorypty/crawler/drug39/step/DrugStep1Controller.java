 ...
 *File: com.glorypty.crawler.drug39.step.DrugStep1Controller.java
 ****************************************************************
 ...
 * @version 1.0
 */
public class DrugStep1Controller extends BaseController {
	...
	public void door(List<String> lstUrls) throws Exception {
		...
		lstUrls.clear();
		crawlController.start(DrugStep1Crawler.class, 1);
	}
	@Override
